...
1. Configure the newly created load balancer with the backend pool named **10979F0501-ilb-bepool** and associate it to the availability set **10979F0501-avSet** with **ipconfig1** of **10979F0501-vm0** and **ipconfig1* of **10979F0501-vm1**.
