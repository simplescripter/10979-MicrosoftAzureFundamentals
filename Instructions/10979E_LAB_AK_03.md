...
1. On the **New** blade, click **Compute** and then click **See all**.

1. On the **Marketplace** blade, in the **Search the Marketplace** text box, type **Windows Server** and press the **Enter** key.
