...
1. On the Install the Azure PowerShell module page, review the instructions for installing the Azure PowerShell module.
...
1. When prompted whether to install PowerShellGet to install and import the NuGet provider, type **Y** and press the **Enter** key.

1. When prompted whether to install the modules from PSGallery, type **Y** and press the **Enter** key.
